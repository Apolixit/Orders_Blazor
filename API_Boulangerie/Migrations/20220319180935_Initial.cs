        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ID_ParentCategory = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryProduct", x => x.ID_Category);
                    table.ForeignKey(
                        name: "FK_CategoryProduct_CategoryProduct_ID_ParentCategory",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_Portion = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NbPortion = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Portion", x => x.ID_Portion);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdditionnalDetails = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_Product = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ID_Portion = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_CategoryProduct_ID_Category",
                        column: x => x.ID_Category,
                        principalTable: "CategoryProduct",
                        principalColumn: "ID_Category");
                    table.ForeignKey(
                        name: "FK_Products_Portion_ID_Portion",
                        column: x => x.ID_Portion,
                        principalTable: "Portion",
                        principalColumn: "ID_Portion");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_OrderDetails = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryProduct_ID_ParentCategory",
